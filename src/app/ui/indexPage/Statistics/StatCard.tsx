...
export const StatCard: FC<Props> = ({ type, count }) => {
  ...
  return (
    <div className='flex justify-between px-[10px] py-[12px] border-[1px] border-borderGray rounded-[16px] mb-[8px] last:mb-0 hover:border-whitePrimary transition ease-in-out duration-300'>
